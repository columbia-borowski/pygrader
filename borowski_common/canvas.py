...
class Canvas:
    ...
    def get_students(self) -> dict[str, Any]:
        ...
        Returns:
            dict[str, Any]: A dictionary mapping student login IDs to student objects.
        """
    ...
    def get_tas(self) -> dict[str, Any]:
        """
        Retrieves a dictionary of TAs.

        Returns:
            dict[str, Any]: A dictionary mapping TA login IDs to TA objects.
        """
        if not self.tas:
            self.tas = {
                ta.login_id: ta
